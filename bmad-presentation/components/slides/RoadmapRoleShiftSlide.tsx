...
export default createSceneSlide({
  kind: "editorial",
  kicker: "Phần 1",
  title: "Điểm Gãy Của Vibe Coding",
  headline: "Khi phạm vi phình ra, chat history không còn là bộ nhớ hệ thống đáng tin.",
  summary: "Bản vá chồng lên bản vá, ràng buộc cũ mờ dần, và công sức điều hướng AI tăng lên nhanh hơn cảm giác tốc độ ban đầu.",
  bullets: [
